...
export class Features {
    ...
    renderInventory() {
        ...
        const items = owned.inventory ?? [], backpack = items.filter((i) => !i.equipped && !i.listed), filtered = itemStacks(backpack).filter((i) => this.inventoryTab === 'other' ? (i.definition.hero && i.definition.hero !== hero) : (!i.definition.hero || i.definition.hero === hero));
